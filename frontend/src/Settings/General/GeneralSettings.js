    ...
    return (
      <PageContent title={translate('GeneralSettings')}>
        ...
        <ConfirmModal
          ...
          message={
            `MangaArr requires a restart to apply changes, do you want to restart now? ${isWindowsService ? 'Depending which user is running the MangaArr service you may need to restart MangaArr as admin once before the service will start automatically.' : ''}`
          }
